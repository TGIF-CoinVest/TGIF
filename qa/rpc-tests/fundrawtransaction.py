...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid coinvest address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid coinvest address" in e.error['message'])
