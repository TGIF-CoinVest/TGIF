...
official/supported Docker Images found at https://hub.docker.com/r/coinvestpay/coinvestd/
...
**NOTE: Please update the image description at https://hub.docker.com/r/coinvestpay/coinvestd-develop/ when changing the above text**