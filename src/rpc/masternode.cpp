...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print CoinVest address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "coinvest",               "masternode",             &masternode,             true,  {} },
    { "coinvest",               "masternodelist",         &masternodelist,         true,  {} },
    { "coinvest",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "coinvest",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "coinvest",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "coinvest",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
