...
UniValue gobject(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp  ||
        ...
        throw std::runtime_error(
                ...
                "  vote-conf          - Vote on a governance object by masternode configured in coinvest.conf\n"
    ...
    */
    ...
    if(strCommand == "vote-conf")
    {
        ...
        if(!fMnFound) {
            ...
            resultsObj.push_back(Pair("coinvest.conf", statusObj));
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    /* CoinVest features */
    { "coinvest",               "getgovernanceinfo",      &getgovernanceinfo,      true,  {} },
    { "coinvest",               "getsuperblockbudget",    &getsuperblockbudget,    true,  {"index"} },
    { "coinvest",               "gobject",                &gobject,                true,  {} },
    { "coinvest",               "voteraw",                &voteraw,                true,  {} },
