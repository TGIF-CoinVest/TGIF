    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("TGIF-light"), QVariant("light"));
    ui->theme->addItem(QString("TGIF-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("TGIF-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("TGIF-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("TGIF-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("TGIF-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("TGIF-traditional"), QVariant("trad"));
