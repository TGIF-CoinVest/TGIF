    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  coinvest-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the CoinVest in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 TGIF, 0.1 TGIF, 1 TGIF and 10 TGIF -- sort of like the paper money you use every day.</li> \
