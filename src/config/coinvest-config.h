/* src/config/coinvest-config.h.  Generated from coinvest-config.h.in by configure.  */
/* src/config/coinvest-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef TGIF_CONFIG_H

#define TGIF_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The CoinVest Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "CoinVest Core"
...
#define PACKAGE_BUGREPORT "https://github.com/coinvestpay/coinvest/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "CoinVest Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "CoinVest Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "coinvestcore"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://coinvest.org/"
