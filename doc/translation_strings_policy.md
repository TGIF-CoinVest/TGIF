...
This document provides guidelines for internationalization of the CoinVest Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `coinvest_en.ts` remains unchanged.
