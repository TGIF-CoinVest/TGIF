...
This mechanism has been integrated into Bitcore-Node-CoinVest which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/coinvestpay/insight-api-coinvest#web-socket-api](https://github.com/coinvestpay/insight-api-coinvest#web-socket-api)
* API: [https://github.com/coinvestpay/insight-api-coinvest#instantsend-transactions](https://github.com/coinvestpay/insight-api-coinvest#instantsend-transactions)
...
By default, the CoinVest Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the CoinVest Core daemon:
